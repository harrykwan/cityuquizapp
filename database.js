var mydata = [{
    ...
    name: "性格測試(一)",
    type: "pointchoose",
    readme: "<ul style=' margin-left: 10px; margin-right: 10px; font-size: 22px; padding-right: 10px; text-align: left;'><li>在這個測試裡，有一些形容人們性格的短句</li><li>在每一短句之後，有五個選擇</li><li>請在五個選擇中，選取最能確切形容你現時的感受和行為</li><li>這不是測驗，並沒有所謂正確的答案</li><li>請你回答所有問題(共50題)</li></ul>",
