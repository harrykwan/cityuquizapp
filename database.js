var mydata = [{
    ...
    name: "人格測試(一)",
    type: "pointchoose",
    readme: "<div style=' padding-left: 10px; font-size: 20px; padding-right: 10px; text-align: center;'>在這個測試裡，有一些形容人們性格的短句。<br>在每一短句之後，有五個選擇。<br>請在五個選擇中，選取最能確切形容你現時的感受和行為。<br>這不是測驗，並沒有所謂正確的答案。<br>請你回答所有問題(共50題)。</div>",
